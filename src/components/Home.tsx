...
const Home = () => {
  return (
    <section className='w-full before:top-0 before:left-0 before:pointer-events-none before:fixed before:h-screen before:w-screen before:content-[" "] before:bg-home-background before:bg-fixed before:bg-no-repeat before:lg:bg-cover before:bg-[length:auto_100vh] before:-z-10'>
